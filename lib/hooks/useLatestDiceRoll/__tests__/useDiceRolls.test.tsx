      ...
      const rolls: Array<IDiceRollResult> = [
        {
          ...
          commandResult: [
            { value: 1, command: "coin", type: RollType.DiceCommand },
          ],
        },
      ];
      ...
      const rolls: Array<IDiceRollResult> = [
        {
          ...
          commandResult: [
            { value: 5, command: "1d6", type: RollType.DiceCommand },
            { value: 3, command: "1d6", type: RollType.DiceCommand },
          ],
        },
      ];
      ...
      const rolls: Array<IDiceRollResult> = [
        {
          ...
          commandResult: [
            { value: 45, command: "1d100", type: RollType.DiceCommand },
          ],
        },
      ];
