...
export const frTranslation = {
  ...
  "character-dialog.close-confirmation": `Etes-vous sûr de vouloir fermer votre fiche de personnage et perdre toutes vos modifications?`,
  "character-dialog.consequences": `Conséquences`,
  "character-dialog.delete": `Supprimer`,
  "character-dialog.load-template-confirmation": `Etes-vous sûr que vous voulez charger ce gabarit et de perdre toutes vos modifications?`,
  ...
  "characters-route.delete-character-confirmation": `Etes-vous sûr de vouloir supprimer ce personnage?`,
  ...
  "home-route.subtitle1": `Fari est une application virtuelle qui est Tabletop méticuleusement adapté pour jouer le RPG Fate (Core accéléré ou condensé).`,
  // omg...
  "home-route.subtitle2": `Il facilite la description des scènes, en gardant un œil sur les personnages et leurs points de destin, le suivi et les aspects encore plus. des solutions intelligentes pour obtenir Concevoir vos personnages de situations précaires les dés de fudge (ou GM) les obligeaient à, laissez votre collectif sauvage imagination courir et tissent des histoires mémorables ensemble!`,
  "home-route.support-fari.description": `Fari est libre de droit. Je crois que dans la construction d'une grande logiciels et des applications qui profite à la communauté. Cependant, il apporte aussi des défis en matière de soutenir les développeurs derrière le projet. \ N \ n Le maintien et le développement de nouvelles fonctionnalités Fari prend beaucoup de temps. Mais avec votre aide financière, je pourrais passer plus de temps sur Fari pour le rendre meilleur ou utiliser le financement pour mettre à niveau les serveurs. \ N \ n Tout don aide, mais si vous votre situation financière empêche d'aider financièrement le projet, vous pouvez toujours aider en passant le mot!`,
  ...
  "menu.play": `Jouer`,
  "menu.scenes": `Scènes`,
  "play-route.add-aspect": `Ajouter un aspect`,
  "play-route.add-bad-guy": `Ajouter un adversaire`,
  "play-route.add-boost": `Ajouter un Boost`,
  "play-route.add-character": `Ajouter personnages`,
  "play-route.add-index-card": `Ajouter une carte d'index`,
  "play-route.add-npc": `Ajouter PNJ`,
  ...
  "play-route.click-on-the-add-aspect-": `Ajouter un aspect`,
  ...
  "play-route.or-pick-existing": `Ou choisir un personnage existant`,
  ...
  "play-route.reset-scene": `Réinitialiser la scène`,
  "play-route.roll": `Lancer`,
  "play-route.save-scene": `Enregistrer Scène`,
