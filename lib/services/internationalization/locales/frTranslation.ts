...
> = {
  ...
  "character-dialog.control.add-field": `Ajouter un champ`,
  "character-dialog.control.add-page": `Ajouter une page`,
  "character-dialog.control.add-section": `Ajouter une section`,
  "character-dialog.control.move-down": `Déplacer vers le bas`,
  "character-dialog.control.move-up": `Déplacer vers le haut`,
  "character-dialog.control.remove-box": `Retirer une boîte`,
  "character-dialog.control.remove-field": `Retirer le champ`,
  ...
  "character-dialog.refresh": `Restauration`,
