...
export const enTranslation = {
  ...
  "home-route.instabilities-1": `Play Online Possible Instabilities`,
  "home-route.instabilities-2": `Fari online functionnalities use a free PeerJS server which is shared with a lot of people and can sometime go down or reach it's concurrent number of users limit.`,
  "home-route.instabilities-3": `If you are having issues starting or joining a game, try to refresh the page or use the Offline Mode.`,
  "home-route.instabilities-4": `I'm currently investing hosting my own server for this (Issue #65 on Github). Stay tuned and sorry for the inconvenience.`,
