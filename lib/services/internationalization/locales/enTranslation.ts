...
export const enTranslation = {
  ...
  "home-route.meta.description": `Fari is a Virtual Tabletop App that is meticulously tailored for playing the Fate RPG (Core, Accelerated or Condensed). It facilitates describing scenes, keeping an eye on the characters and their fate points, tracking aspects and even more. Conceive clever solutions to get your characters out of precarious situations the fudge dice (or the GM) forced them in, let your collective imagination run wild and weave memorable stories together!`,
