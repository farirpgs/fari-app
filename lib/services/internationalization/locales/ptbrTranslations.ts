...
export const ptbrTranslation = {
  ...
  "character-dialog.stress": `Estresse`,
  "character-dialog.stunts-extras": `Façanhas & Extras`,
  ...
  "menu.play": `Jogar`,
  "menu.scenes": `Cenas`,
  "play-route.add-aspect": `Adicionar Aspecto`,
  "play-route.add-bad-guy": `Adicionar Inimigo`,
  "play-route.add-boost": `Adicionar Impulso`,
  "play-route.add-character": `Adicionar Personagem`,
  "play-route.add-index-card": `Adicionar Card de Anotação`,
  "play-route.add-npc": `Adicionar PdN`,
  ...
  "play-route.click-on-the-add-aspect-": `Adicionar Aspecto`,
  ...
  "play-route.load-scene": `Carregar Cena`,
  "play-route.load-scene-as-template": `Carregar Cena como Template`,
  "play-route.name": `Nome`,
  "play-route.new-scene": `Nova Cena`,
  "play-route.no-aspects": `A cena não tem aspectos ainda.`,
  "play-route.or-pick-existing": `Ou escolha um Personagem existente`,
  ...
  "play-route.reset-scene": `Resetar Cena`,
  "play-route.roll": `Rolar`,
  "play-route.save-scene": `Salvar Cene`,
